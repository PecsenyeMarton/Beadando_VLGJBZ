	...
	if(empty($worker)) :
		header('Location: index.php');
			...
			<form method="post">
				...
				<div class="form-row">
					<div class="form-group col-md-12">
						...
						<select class="form-control" id="workerGender" name="gender">
							<option value="0" <?=$worker['gender'] == 0 ? 'selected' : '' ?> >Nő</option>
							<option value="1" <?=$worker['gender'] == 1 ? 'selected' : '' ?> >Férfi</option>
							<option value="2" <?=$worker['gender'] == 2 ? 'selected' : '' ?> >Egyéb</option>
						</select>
					</div>
				</div>
				...
				<div class="form-row">
					<div class="form-group col-md-12">
						<label for="workerNationality">Nemzetiség</label>
